...
const Login = () => {
  ...
  const handleForgetPassword = () => {
    if(!email){
      toast.warning("Please enter your email before resetting your password.")
      return
    }
    if(email && password){
      toast.warning("If your password is correct, you can login instead of resetting it.")
      return
    }
    ...
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
       ...
       <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm' >
        ...
        <form onSubmit={onSubmitHandler}>
           ...
           {/* Show Forget Password only on Login */}
           {state === 'Login' && (
             <p onClick={handleForgetPassword} className='mb-4 text-indigo-500 cursor-pointer'>
               Forget Password
             </p>
           )}
